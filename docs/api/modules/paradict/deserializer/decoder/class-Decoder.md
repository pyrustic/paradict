...
[Home](/docs/api/README.md) | [Project](/README.md) | [Module](/docs/api/modules/paradict/deserializer/decoder/README.md) | [Source](/src/paradict/deserializer/decoder.py)
...
```python
def __init__(self, *, type_ref=None, receiver=None, obj_builder=None, root_dir=None):
    ...
```
